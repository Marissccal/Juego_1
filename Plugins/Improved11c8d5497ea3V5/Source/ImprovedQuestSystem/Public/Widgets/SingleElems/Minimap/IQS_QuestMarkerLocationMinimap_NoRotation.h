...
#include "IQS_QuestMarkerLocationMinimap_NoRotation.generated.h"

UCLASS(Blueprintable)
class IMPROVEDQUESTSYSTEM_API UIQS_QuestMarkerLocationMinimap_NoRotation : public UIQS_MinimapMarkerBase
{
	GENERATED_BODY()
